...
The % used above represents any character or set of characters. In the type of SQL that Mode uses, LIKE is case-sensitive, meaning that the above query will only capture matches that start with a capital “S” and lower-case “noop.” 
*/

--To ignore case when you’re matching values, you can use the ILIKE command as following:
SELECT *
FROM testDB
